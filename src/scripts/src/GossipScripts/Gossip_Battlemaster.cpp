...
void SetupBattlemaster(ScriptMgr * mgr)
{
    ...
    mgr->register_gossip_script(7247, &AlteracValleyBattlemaster::Create); // Sandfury Soul Eater (is it BG Master?:|)
    mgr->register_gossip_script(14942, &AlteracValleyBattlemaster::Create);// Kartra Bloodsnarl

    mgr->register_gossip_script(7427, &AlteracValleyBattlemaster::Create); // Taim Ragetotem
