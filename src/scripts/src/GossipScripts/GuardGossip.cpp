...
class SCRIPT_DECL NorthshireGuard : public GossipScript
{
public:
    ADD_GOSSIP_FACTORY_FUNCTION(NorthshireGuard);
    void GossipHello(Creature* pCreature, Player* Plr, bool AutoSend);
    void GossipSelectOption(Creature* pCreature, Player* Plr, uint32 Id, uint32 IntId);
    void GossipEnd(Creature* pCreature, Player* Plr);
};
...
class SCRIPT_DECL TeldrassilGuard : public GossipScript
{
public:
    ADD_GOSSIP_FACTORY_FUNCTION(TeldrassilGuard);
    void GossipHello(Creature * pCreature, Player * Plr, bool AutoSend)
    {
        GossipMenu *Menu;
...
{
    /* Guard List */
    mgr->register_gossip_script(1423, &NorthshireGuard::Create);        // Northshire Guard 
    ...
    mgr->register_gossip_script(4262, &DarnassusGuard::Create);        // Darnassus sentinal
    mgr->register_gossip_script(5624, &UndercityGuard::Create);     // Undercity
    mgr->register_gossip_script(3571, &TeldrassilGuard::Create);	// Teldrassil
}
