...
bool ChatHandler::HandleNpcInfoCommand(const char *args, WorldSession *m_session)
{
	...
	GreenSystemMessage(m_session, "Base Holy: %d", crt->GetUInt32Value(UNIT_FIELD_RESISTANCES_2));
	GreenSystemMessage(m_session, "Base Fire: %d", crt->GetUInt32Value(UNIT_FIELD_RESISTANCES_3));
	GreenSystemMessage(m_session, "Base Nature: %d", crt->GetUInt32Value(UNIT_FIELD_RESISTANCES_4));
	GreenSystemMessage(m_session, "Base Frost: %d", crt->GetUInt32Value(UNIT_FIELD_RESISTANCES_5));
	GreenSystemMessage(m_session, "Base Shadow: %d", crt->GetUInt32Value(UNIT_FIELD_RESISTANCES_6));
	GreenSystemMessage(m_session, "Base Arcane: %d", crt->GetUInt32Value(UNIT_FIELD_RESISTANCES_7));
...
bool ChatHandler::HandleGORotate(const char * args, WorldSession * m_session)
{
	...
	go->ModFloatValue(GAMEOBJECT_ROTATION_X2, rad);
	go->ModFloatValue(GAMEOBJECT_ROTATION_X3, rad);
	go->ModFloatValue(GAMEOBJECT_ROTATION_X4, rad);
	go->SaveToDB();
