...
bool ChatHandler::HandleGOSpawn(const char *args, WorldSession *m_session)
{
	...
	go->SetFloatValue(GAMEOBJECT_ROTATION_X3, sinf(o / 2));
	go->SetFloatValue(GAMEOBJECT_ROTATION_X4, cosf(o / 2));
	...
	gs->o1 = go->GetFloatValue(GAMEOBJECT_ROTATION_X2);
	gs->o2 = go->GetFloatValue(GAMEOBJECT_ROTATION_X3);
	gs->o3 = go->GetFloatValue(GAMEOBJECT_ROTATION_X4);
