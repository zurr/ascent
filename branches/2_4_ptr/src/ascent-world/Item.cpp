...
void Item::Create( uint32 itemid, Player* owner )
{
	...
	SetUInt32Value( ITEM_FIELD_SPELL_CHARGES_2, m_itemProto->Spells[1].Charges );
	SetUInt32Value( ITEM_FIELD_SPELL_CHARGES_3, m_itemProto->Spells[2].Charges );
	SetUInt32Value( ITEM_FIELD_SPELL_CHARGES_4, m_itemProto->Spells[3].Charges );
	SetUInt32Value( ITEM_FIELD_SPELL_CHARGES_5, m_itemProto->Spells[4].Charges );
