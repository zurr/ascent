...
void WarsongGulch::SpawnBuff(uint32 x)
{
	...
	case 0:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.73135370016098f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X4,-0.681998312473297f);
	...
	case 1:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.73135370016098f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X4,0.681998372077942f);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 2:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.130526319146156f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X4,-0.991444826126099f);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 3:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.333806991577148f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X4,-0.94264143705368f);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 4:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.559192895889282f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X4,0.829037606716156f);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 5:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.939692616462708f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X4,-0.342020124197006f);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
...
void WarsongGulch::OnCreate()
{
	...
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X2,-0.004956f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X3,-0.283972f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X4,0.9586736f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);
	...
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X2,0.1575096f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X3,-0.8239487f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X4,0.5073640f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);
