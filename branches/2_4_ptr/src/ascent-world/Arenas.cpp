...
void Arena::OnCreate()
{
	...
	case 572: {
		...
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X3, 0.746058f);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X4, 0.665881f);
		m_gates.insert(obj);

		obj = SpawnGameObject(185918, 572, 1293.560791f, 1601.937988f, 31.605574f, -1.457349f, 32, 1375, 1.0f);
		obj->SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X3, -0.665881f);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X4, 0.746058f);
		m_gates.insert(obj);
	...
	case 562: {
		...
		obj->SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X3, 0.90445f);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X4, -0.426569f);
		obj->PushToWorld(m_mapMgr);

		obj = SpawnGameObject(183973, 562, 6189.546387f, 241.709854f, 3.101481f, 0.881392f, 32, 1375, 1.0f);
		obj->SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X3, 0.426569f);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X4, 0.904455f);
		m_gates.insert(obj);
		...
		obj->SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X3, 0.904455f);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X4, -0.426569f);
		m_gates.insert(obj);
			  }break;
	...
	case 559: {
		...
		obj->SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X3, 0.243916f);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X4, 0.969796f);
		obj->PushToWorld(m_mapMgr);
		...
		obj->SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X3, 0.969796f);
		obj->SetFloatValue(GAMEOBJECT_ROTATION_X4, -0.243916f);
		obj->PushToWorld(m_mapMgr);
