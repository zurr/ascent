...
void GameObject::SaveToDB()
{
	...
	ss << "REPLACE INTO gameobject_spawns VALUES("
		...
		<< GetFloatValue(GAMEOBJECT_ROTATION_X2) << ","
		<< GetFloatValue(GAMEOBJECT_ROTATION_X3) << ","
		<< GetFloatValue(GAMEOBJECT_ROTATION_X4) << ","
...
bool GameObject::Load(GOSpawn *spawn)
{
	...
	SetFloatValue(GAMEOBJECT_ROTATION_X2 ,spawn->o1);
	SetFloatValue(GAMEOBJECT_ROTATION_X3 ,spawn->o2);
	SetFloatValue(GAMEOBJECT_ROTATION_X4 ,spawn->o3);
