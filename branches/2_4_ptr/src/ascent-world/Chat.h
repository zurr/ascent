...
enum ChatMsg
{
	...
	CHAT_MSG_SKILL									= 0x18,
	CHAT_MSG_LOOT									= 0x19,
	CHAT_MSG_COMBAT_MISC_INFO						= 0x1A,
	CHAT_MSG_MONSTER_WHISPER						= 0x1B,
	CHAT_MSG_COMBAT_SELF_HITS						= 0x1C,
	CHAT_MSG_COMBAT_SELF_MISSES						= 0x1D,
	CHAT_MSG_COMBAT_PET_HITS						= 0x1E,
	CHAT_MSG_COMBAT_PET_MISSES						= 0x1F,
	CHAT_MSG_COMBAT_PARTY_HITS						= 0x20,
	CHAT_MSG_COMBAT_PARTY_MISSES					= 0x21,
	CHAT_MSG_COMBAT_FRIENDLYPLAYER_HITS				= 0x22,
	CHAT_MSG_COMBAT_FRIENDLYPLAYER_MISSES			= 0x23,
	CHAT_MSG_COMBAT_HOSTILEPLAYER_HITS				= 0x24,
	CHAT_MSG_COMBAT_HOSTILEPLAYER_MISSES			= 0x25,
	CHAT_MSG_COMBAT_CREATURE_VS_SELF_HITS			= 0x26,
	CHAT_MSG_COMBAT_CREATURE_VS_SELF_MISSES			= 0x27,
	CHAT_MSG_COMBAT_CREATURE_VS_PARTY_HITS			= 0x28,
	CHAT_MSG_COMBAT_CREATURE_VS_PARTY_MISSES		= 0x29,
	CHAT_MSG_COMBAT_CREATURE_VS_CREATURE_HITS		= 0x2A,
	CHAT_MSG_COMBAT_CREATURE_VS_CREATURE_MISSES		= 0x2B,
	CHAT_MSG_COMBAT_FRIENDLY_DEATH					= 0x2C,
	CHAT_MSG_COMBAT_HOSTILE_DEATH					= 0x2D,
	CHAT_MSG_COMBAT_XP_GAIN							= 0x2E,
	CHAT_MSG_SPELL_SELF_DAMAGE						= 0x2F,
	CHAT_MSG_SPELL_SELF_BUFF						= 0x30,
	CHAT_MSG_SPELL_PET_DAMAGE						= 0x31,
	CHAT_MSG_SPELL_PET_BUFF							= 0x32,
	CHAT_MSG_SPELL_PARTY_DAMAGE						= 0x33,
	CHAT_MSG_SPELL_PARTY_BUFF						= 0x34,
	CHAT_MSG_SPELL_FRIENDLYPLAYER_DAMAGE			= 0x35,
	CHAT_MSG_SPELL_FRIENDLYPLAYER_BUFF				= 0x36,
	CHAT_MSG_SPELL_HOSTILEPLAYER_DAMAGE				= 0x37,
	CHAT_MSG_SPELL_HOSTILEPLAYER_BUFF				= 0x38,
	CHAT_MSG_SPELL_CREATURE_VS_SELF_DAMAGE			= 0x39,
	CHAT_MSG_SPELL_CREATURE_VS_SELF_BUFF			= 0x3A,
	CHAT_MSG_SPELL_CREATURE_VS_PARTY_DAMAGE			= 0x3B,
	CHAT_MSG_SPELL_CREATURE_VS_PARTY_BUFF			= 0x3C,
	CHAT_MSG_SPELL_CREATURE_VS_CREATURE_DAMAGE		= 0x3D,
	CHAT_MSG_SPELL_CREATURE_VS_CREATURE_BUFF		= 0x3E,
	CHAT_MSG_SPELL_TRADESKILLS						= 0x3F,
	CHAT_MSG_SPELL_DAMAGESHIELDS_ON_SELF			= 0x40,
	CHAT_MSG_SPELL_DAMAGESHIELDS_ON_OTHERS			= 0x41,
	CHAT_MSG_SPELL_AURA_GONE_SELF					= 0x42,
	CHAT_MSG_SPELL_AURA_GONE_PARTY					= 0x43,
	CHAT_MSG_SPELL_AURA_GONE_OTHER					= 0x44,
	CHAT_MSG_SPELL_ITEM_ENCHANTMENTS				= 0x45,
	CHAT_MSG_SPELL_BREAK_AURA						= 0x46,
	CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE				= 0x47,
	CHAT_MSG_SPELL_PERIODIC_SELF_BUFFS				= 0x48,
	CHAT_MSG_SPELL_PERIODIC_PARTY_DAMAGE			= 0x49,
	CHAT_MSG_SPELL_PERIODIC_PARTY_BUFFS				= 0x4A,
	CHAT_MSG_SPELL_PERIODIC_FRIENDLYPLAYER_DAMAGE	= 0x4B,
	CHAT_MSG_SPELL_PERIODIC_FRIENDLYPLAYER_BUFFS	= 0x4C,
	CHAT_MSG_SPELL_PERIODIC_HOSTILEPLAYER_DAMAGE	= 0x4D,
	CHAT_MSG_SPELL_PERIODIC_HOSTILEPLAYER_BUFFS		= 0x4E,
	CHAT_MSG_SPELL_PERIODIC_CREATURE_DAMAGE			= 0x4F,
	CHAT_MSG_SPELL_PERIODIC_CREATURE_BUFFS			= 0x50,
	CHAT_MSG_SPELL_FAILED_LOCALPLAYER				= 0x51,
	CHAT_MSG_COMBAT_HONOR_GAIN						= 0x52,
	CHAT_MSG_BG_EVENT_NEUTRAL						= 0x53,
	CHAT_MSG_BG_EVENT_ALLIANCE						= 0x54,
	CHAT_MSG_BG_EVENT_HORDE							= 0x55,
	CHAT_MSG_COMBAT_FACTION_CHANGE					= 0x56,
	CHAT_MSG_MONEY									= 0x57,
	CHAT_MSG_RAID_LEADER							= 0x58,
	CHAT_MSG_RAID_WARNING							= 0x59,
	CHAT_MSG_FOREIGN_TELL							= 0x5A,
	CHAT_MSG_RAID_BOSS_EMOTE						= 0x5B,
	CHAT_MSG_FILTERED								= 0x5C,
	CHAT_MSG_BATTLEGROUND							= 0x5D,
	CHAT_MSG_BATTLEGROUND_LEADER					= 0x5E,
	CHAT_MSG_MONSTER_PARTY							= 0x5F,
	CHAT_MSG_RESTRICTED								= 0x60,
};
#endif
