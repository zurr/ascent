...
bool Creature::Load(CreatureSpawn *spawn, uint32 mode, MapInfo *info)
{
	...
	SetUInt32Value(UNIT_VIRUTAL_ITEM_SLOT_DISPLAY_2, proto->Item2SlotDisplay);
	SetUInt32Value(UNIT_VIRUTAL_ITEM_SLOT_DISPLAY_3, proto->Item3SlotDisplay);
	SetUInt32Value(UNIT_VIRTUAL_ITEM_INFO, proto->Item1Info1);
	SetUInt32Value(UNIT_VIRTUAL_ITEM_INFO_2, proto->Item1Info2);
	SetUInt32Value(UNIT_VIRTUAL_ITEM_INFO_3, proto->Item2Info1);
	SetUInt32Value(UNIT_VIRTUAL_ITEM_INFO_4, proto->Item2Info2);
	SetUInt32Value(UNIT_VIRTUAL_ITEM_INFO_5, proto->Item3Info1);
	SetUInt32Value(UNIT_VIRTUAL_ITEM_INFO_6, proto->Item3Info2);
