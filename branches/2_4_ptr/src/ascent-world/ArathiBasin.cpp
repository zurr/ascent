...
void ArathiBasin::SpawnBuff(uint32 x)
{
	...
	if(m_buffs[x] == NULL)
	{
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X3, BuffRotations[x][0]);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_ROTATION_X4, BuffRotations[x][1]);
...
void ArathiBasin::SpawnControlPoint(uint32 Id, uint32 Type)
{
	...
	if(m_controlPoints[Id] == NULL)
	{
		...
		m_controlPoints[Id]->SetFloatValue(GAMEOBJECT_ROTATION_X3, ControlPointRotations[Id][0]);
		m_controlPoints[Id]->SetFloatValue(GAMEOBJECT_ROTATION_X4, ControlPointRotations[Id][1]);
	...
	if(m_controlPointAuras[Id] == NULL)
	{
		...
		m_controlPointAuras[Id]->SetFloatValue(GAMEOBJECT_ROTATION_X3, ControlPointRotations[Id][0]);
		m_controlPointAuras[Id]->SetFloatValue(GAMEOBJECT_ROTATION_X4, ControlPointRotations[Id][1]);
...
void ArathiBasin::OnCreate()
{
	...
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X2,-0.0602880f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.3449600f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X4,0.9365900f);
	...
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X2,0.0151270f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X3,0.9292169f);
	gate->SetFloatValue(GAMEOBJECT_ROTATION_X4,-0.3657840f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);
