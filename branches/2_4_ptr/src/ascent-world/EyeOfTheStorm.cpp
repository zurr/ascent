...
void EyeOfTheStorm::OnCreate()
{
	...
	m_standFlag->SetFloatValue( GAMEOBJECT_ROTATION_X3, 0.662620f );
	m_standFlag->SetFloatValue( GAMEOBJECT_ROTATION_X4, -0.748956f );
	...
	m_dropFlag->SetFloatValue( GAMEOBJECT_ROTATION_X3, 0.885448f );
	m_dropFlag->SetFloatValue( GAMEOBJECT_ROTATION_X4, -0.464739f );
